...
public class EasyB : MonoBehaviour, IScoreUpdater {

    public float moveSpeed;		// The speed the enemy moves at.
    ...
    private IScoreUpdater successor;
	...
	void Death()
	{
        ...
        // Increase the score by 500 points
        //score.score += 500;
        score.score +=scoreUpdater.invoke("EasyB");
    ...
    public int incrementScore(String enemy)
    {
        if (enemy == "EasyB")
        {
            //score.score += 500;
        ...
        else
        {
            if (successor != null)
            {
                return successor.incrementScore(enemy);
            }
            else
            {
                return 0;
