...
public class HardA : MonoBehaviour, IScoreUpdater {
	//private IEnemyFactory factory = new EnemyFactoryHard ();
	...
	void Death()
	{
        ...
        // Increase the score by 750 points
        //score.score += 750;
        score.score += scoreUpdater.invoke("HardA");
